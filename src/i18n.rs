// Internationalization support for Agent Deck
...
pub mod ui {
    ...
    impl Translate for Welcome {
        fn t(&self, lang: Language) -> &'static str {
            match lang {
                Language::English => "Welcome to Agent Deck!",
                Language::Chinese => "欢迎使用 Agent Deck！",
            }
        }
    }

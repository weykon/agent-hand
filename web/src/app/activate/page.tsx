    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-6">
        <div className="max-w-md text-center">
          <h2 className="mb-2 text-2xl font-bold">No Device Code</h2>
          <p className="text-[#94a3b8]">
            Run <code className="rounded bg-[#1a1a2e] px-1.5 py-0.5">agent-hand login</code> in your terminal to get started.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-6">
      <div className="w-full max-w-sm rounded-xl border border-[#333] bg-[#1a1a2e] p-8 text-center">
        <h2 className="mb-2 text-2xl font-bold">Authorize Device</h2>
        <p className="mb-2 text-[#94a3b8]">Your device code:</p>
        <p className="mb-6 font-mono text-3xl font-bold tracking-widest text-[#6366f1]">{code}</p>
        <p className="mb-6 text-sm text-[#94a3b8]">Sign in to link your account to this device.</p>

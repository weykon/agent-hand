...
![Agent Hand Logo](assets/logo/agent-hand-full.png)
...
<a href="#install"><b>Install</b></a> · <a href="#quickstart">Quickstart</a> · <a href="#highlights">Highlights</a> · <a href="#keybindings-tui">Keybindings</a> · <a href="#cli">CLI</a> · <a href="#status-detection-customization-optional">Config</a> · <a href="#changelog">Changelog</a>
...
| Platform | Command |
|----------|---------|
| **macOS / Linux** | `brew install weykon/tap/agent-hand` |
| **Windows** | `scoop bucket add agent-hand https://github.com/weykon/scoop-agent-hand && scoop install agent-hand` |

That's it. Auto-updates included — `brew upgrade` / `scoop update` will pick up new releases automatically.
...
```powershell
# Windows (native PowerShell — requires MSYS2/Cygwin with tmux)
